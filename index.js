...
descriptionElement.innerHTML = `
    ...
    Currently, ${numberOfUnfundedGames} game${numberOfUnfundedGames !== 1 ? "s remain" : " remains"} unfunded. We need your support!
`;
...
firstGameElement.innerHTML = `
    ...
    Pledged: $${firstGame.pledged.toLocaleString()}<br>
    Goal: $${firstGame.goal.toLocaleString()}<br>
    Backers: ${firstGame.backers.toLocaleString()}
`;
...
secondGameElement.innerHTML = `
    ...
    Pledged: $${secondGame.pledged.toLocaleString()}<br>
    Goal: $${secondGame.goal.toLocaleString()}<br>
    Backers: ${secondGame.backers.toLocaleString()}
`;
secondGameContainer.appendChild(secondGameElement);

/*************************************************************************************
 * Additional Features: Search Bar and Sorting
*/
...
sortButton.addEventListener("click", () => {
    ...
    let sortedGames;
    if (sortBy === "funding") {
        sortedGames = [...GAMES_JSON].sort((a, b) => b.pledged - a.pledged);
    } else if (sortBy === "name") {
        sortedGames = [...GAMES_JSON].sort((a, b) => a.name.localeCompare(b.name));
    } else if (sortBy === "backers") {
        sortedGames = [...GAMES_JSON].sort((a, b) => b.backers - a.backers);
    }
